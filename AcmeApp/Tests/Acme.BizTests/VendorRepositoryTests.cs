...
namespace Acme.Biz.Tests
{
    ...
    public class VendorRepositoryTests
    {
        ...
        public void RetrieveWithIteratorTest()
        {
            ...
            //Act
            var vendorIterator = repository.RetrieveWithIterator();                     /////////////        this one      ////////////////            
            foreach (var item in vendorIterator)  // returns first and then internal error
            {
                Console.WriteLine(item);
            }
            var actual = vendorIterator.ToList(); // this one is good
